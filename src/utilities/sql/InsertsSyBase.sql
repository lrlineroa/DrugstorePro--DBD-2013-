...
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1055555555, 1, 1, 'Leonardo', 'Linero', 5555555, 'avenida siempre viva 2445', HASH( 's02258001', 'MD5' ), 'lrlineroa', 'lrlineroa@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1032333333, 1, 1, 'Edward', 'Rojas', 3333333, '345 oasis st', HASH( 's02258009', 'MD5' ), 'earojasc', 'earojasc@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1032333444, 2, 1, 'Stiven', 'Gonzalez', 3333333, 'cra 123', HASH( 's02257765', 'MD5' ), 'dsgonzalezh', 'dsgonzalezh@drugstore.com')	
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1050500500, 2, 1, 'Mauricio', 'Herrera', 1111111, 'cll 9 # 98', HASH( 's02257771', 'MD5' ), 'maherrerapu', 'maherrerapu@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1060600600, 2, 1, 'Jesid', 'Mejia', 2222222, 'tr 32 # 90', HASH( 's02258258', 'MD5' ), 'jemmejiaca', 'jemmejiaca@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1070700700, 2, 1, 'Camilo', 'Peña', 8888888, '345 oasis st', HASH( 's02257956', 'MD5' ), 'capenap', 'capenap@drugstore.com')
...
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (1, 2, 'Metrozin', 10296, 'Receta Medica', 1, 654675672, 0)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (2, 5, 'Keflex', 29955, 'Receta Medica', 1, 654675672, 0)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (3, 1, 'Lincocin', 10656, 'Receta Medica', 6, 342353452, 0)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (4, 3, 'MIcrogynon', 9180, '5 cada 6 horas', 1, 797644453, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (5, 1, 'Descongel', 10000, 'Receta Medica', 1, 342353452, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (6, 1, 'Sinutab', 10000, '1 Cucharada diaria', 1, 342353452, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (7, 2, 'Acetaminofem', 10000, '', 1, 797644453, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (8, 6, 'Maquinade afeitar Gillete', 23000, '', 7, 235678654, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (9, 6, 'Gel de afeitar Gillete', 11349, '', 7, 235678654, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (10, 6, 'Crema Dental Colgate', 8000, '', 7, 235678654, 1)	
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (11, 6, 'Enjuague Bucal', 12000, '', 7, 467893441, 1)	
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (12, 6, 'Helado Casero', 1000, '', 9, 298764453, 1)
INSERT INTO lrlineroa.MEDICAMENTO (ID_PRODUCTO, ID_PRESENTACION, NOMBRE_PRODUCTO, PRECIO_PRODUCTO, POSOLOGIA_PRODUCTO, ID_TIPO_PRODUCTO, ID_PROVEEDOR, VENTA_LIBRE)
	VALUES (13, 6, 'Chocolatina Jet', 500, '', 9, 756756734, 1)
