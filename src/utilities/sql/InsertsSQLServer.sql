...
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1055555555, 1, 1, 'Leonardo', 'Linero', '5555555', 'avenida siempre viva 2445', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02258001')),3,32), 'lrlineroa', 'lrlineroa@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1032333333, 1, 1, 'Edward', 'Rojas', '3333333', '345 oasis st', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02258009')),3,32), 'earojasc', 'earojasc@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1032333444, 2, 1, 'Stiven', 'Gonzalez', '3333333', 'cra 123', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02257765')),3,32), 'dsgonzalezh', 'dsgonzalezh@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1050500500, 2, 1, 'Mauricio', 'Herrera', '1111111', 'cll 9 # 98', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02257771')),3,32), 'maherrerapu', 'maherrerapu@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1060600600, 2, 1, 'Jesid', 'Mejia', '2222222', 'tr 32 # 90', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02258258')),3,32), 'jemmejiaca', 'jemmejiaca@drugstore.com')
INSERT INTO lrlineroa.PERSONA (ID_PERSONA, ID_CARGO, ID_DROGUERIA, NOMBRE_PERSONA, APELLIDO_PERSONA, TELEFONO_PERSONA, DIRECCION_PERSONA, PASSWORD, NOMBRE_DE_USUARIO, CORREO_PERSONA)
	VALUES (1070700700, 2, 1, 'Camilo', 'Pe�a', '8888888', '345 oasis st', SUBSTRING(master.dbo.fn_varbintohexstr(HashBytes('MD5', 's02257956')),3,32), 'capenap', 'capenap@drugstore.com')
...
INSERT INTO lrlineroa.PROVEEDOR (ID_PROVEEDOR, NOMBRE_PROVEEDOR, TELEFONO_PROVEEDOR, DIRECCION_PROVEEDOR)
	VALUES (797644453, 'Biochem Farmac�utica', 6579825, 1)
INSERT INTO lrlineroa.PROVEEDOR (ID_PROVEEDOR, NOMBRE_PROVEEDOR, TELEFONO_PROVEEDOR, DIRECCION_PROVEEDOR)
