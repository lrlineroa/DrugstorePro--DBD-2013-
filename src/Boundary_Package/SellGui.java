...
import Helpers.*;
import Boundary_Package.LoginGui;
...
//        b.add(b); para ver despues
    ...
    private void initComponents() {
        ...
        QueryButton.setBackground(java.awt.Color.white);
        QueryButton.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        QueryButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/xeyes.png"))); // NOI18N
        ...
        IdFormattedTextField.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                IdFormattedTextFieldMouseMoved(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(QueryButton, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(IdFormattedTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
...
//        if(!(nom.length()<51)){
//        if(buscon.MakeQuery(identi) != null){
        ...
        if(QuantyFormattedTextField3.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Faltan Datos por llenar", "advertencia", JOptionPane.OK_OPTION);
               ...
               Long identi=Long.parseLong(this.IdFormattedTextField.getText());
                    ...
                    float price=buscon.MakeQuery(identi,NameTextField1.getText()).getPrecioProducto();
                ...
                float price=buscon.MakeQuery(identi).getPrecioProducto();
                float totalPrice=price*Integer.parseInt(this.QuantyFormattedTextField3.getText());
                if(!resultado.equals("0")){
                    JOptionPane.showMessageDialog(null, resultado, "advertencia", JOptionPane.OK_OPTION);
                if(resultado.toCharArray()[0]=='Q'){
...
//          }
    ...
    private void IdFormattedTextFieldMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IdFormattedTextFieldMouseMoved
        if (!this.IdFormattedTextField.getText().isEmpty()){
            String s=buscon.SearchNameById(Long.parseLong(this.IdFormattedTextField.getText()));
    ...
    }//GEN-LAST:event_IdFormattedTextFieldMouseMoved
    ...
    private void NameTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_NameTextField1FocusLost
        Object Id=buscon.SearchIdByName(NameTextField1.getText());        
        if(!Id.equals(-1)){
           IdFormattedTextField.setText(""+Id);
        }else{
    ...
    private void MakeSellButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MakeSellButtonActionPerformed
        ...
        buscon.newFacture(LoginGui.persL.getIdPersona(), Float.parseFloat(TotalTextField.getText()));
